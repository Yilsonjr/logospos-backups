...
\restrict OSwinL1jqLlTiX2ZO4upBNnz6Eed70g22vAfd1xCtRKIm3fA1ykzjlwrssB2sl3
...
CREATE TABLE public.compra (
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    tipo_cacao public.tipo_cacao,
    precio_quintal_snapshot numeric(12,4),
    lote_secado_id uuid,
...
CREATE VIEW public.inventario_disponible AS
 WITH compras_baba AS (
         SELECT COALESCE(sum(compra.cantidad_kg), (0)::numeric) AS kg_total
           FROM public.compra
          WHERE ((compra.tipo_cacao = 'baba'::public.tipo_cacao) AND (compra.anulada = false))
        ), baba_en_secado AS (
         SELECT COALESCE(sum(sc.kg_aportado), (0)::numeric) AS kg_total
           FROM (public.secado_compras sc
             JOIN public.proceso_secado ps ON ((sc.secado_id = ps.id)))
          WHERE (ps.estado = ANY (ARRAY['en_proceso'::public.estado_secado, 'completado'::public.estado_secado]))
        ), compras_seco AS (
         SELECT COALESCE(sum(compra.cantidad_kg), (0)::numeric) AS kg_total
           FROM public.compra
          WHERE ((compra.tipo_cacao = 'seco'::public.tipo_cacao) AND (compra.anulada = false))
        ), seco_de_procesos AS (
         SELECT COALESCE(sum(proceso_secado.kg_seco_salida), (0)::numeric) AS kg_total
           FROM public.proceso_secado
          WHERE (proceso_secado.estado = 'completado'::public.estado_secado)
        ), vendido AS (
         SELECT COALESCE(sum(
                CASE
                    WHEN true THEN venta_importadora.volumen_kg
                    ELSE NULL::numeric
                END), (0)::numeric) AS kg_total
           FROM public.venta_importadora
        )
 SELECT (( SELECT compras_baba.kg_total
           FROM compras_baba) - ( SELECT baba_en_secado.kg_total
           FROM baba_en_secado)) AS kg_baba_disponible,
    ((( SELECT compras_seco.kg_total
           FROM compras_seco) + ( SELECT seco_de_procesos.kg_total
           FROM seco_de_procesos)) - ( SELECT vendido.kg_total
           FROM vendido)) AS kg_seco_disponible;
...
CREATE TABLE public.precio_diario (
    ...
    fijado_por uuid,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    precio_quintal_baba numeric(12,4),
    precio_anterior_baba numeric(12,4),
    precio_baba_calculado boolean DEFAULT true NOT NULL
);
...
53f0db40-3fa1-45af-a3af-b8d432b2614a	2026-07-05 17:17:07.388405-04	2026-07-05 17:17:07.388405-04	password	81b8a3dc-0cfd-4012-b7f2-b033e762bcf7
5bd0a7d0-01d9-4e37-b209-64d9f51606a4	2026-07-05 17:22:36.107212-04	2026-07-05 17:22:36.107212-04	password	de53dc3f-75b3-452a-bdf0-f78c6547b967
3af6c769-921c-4487-9528-f0d42788fc73	2026-07-05 19:20:55.996701-04	2026-07-05 19:20:55.996701-04	password	da2bbc11-f93c-498e-a929-910ef297ae15
b53928c1-dfb3-494b-8827-e1fef4522e3d	2026-07-05 19:26:09.240804-04	2026-07-05 19:26:09.240804-04	password	112f6ec2-4863-4009-9b8d-594f268e5c4d
04f50683-0fa1-4ca1-9981-52e7ffb721f6	2026-07-08 18:16:13.718301-04	2026-07-08 18:16:13.718301-04	password	97d20a64-c0f3-455c-b1ae-475b49cbfefe
4553ec1c-b54e-41b8-a0c2-955d7d9f12b5	2026-07-09 21:44:01.781815-04	2026-07-09 21:44:01.781815-04	password	52d0d153-4ce5-446c-96a0-24a8211a2ff1
\N	\N			\N		0	\N		\N	f	\N	f
00000000-0000-0000-0000-000000000000	50471f55-7b80-41ea-86ee-4e91338d3864	authenticated	authenticated	admin@cacao.com	$2a$10$QqVsNIR5pPGBkINSDraeQusBOT7CR1wfwIesIJlt2VD0qVKYFG4Vy	2026-07-04 15:51:10.955031-04	\N		\N		\N			\N	2026-07-28 14:01:13.862059-04	{"provider": "email", "providers": ["email"]}	{"email_verified": true}	\N	2026-07-04 15:51:10.946365-04	2026-07-28 18:55:36.351034-04	\N	\N			\N		0	\N		\N	f	\N	f
\.
...
COPY public.abono_proveedor (id, proveedor_id, compra_id, monto, metodo_pago, registrado_por, nota, fecha, created_at) FROM stdin;
31bcbe0b-8d52-4a71-841f-0cd7a2bb1f7f	c4029e46-c14e-465c-b870-b3b4ef8c06d5	b5927603-b5f5-457e-a78a-a6254d100318	10000.00	efectivo	74aa956e-5a01-4633-aebf-165e9e933974	\N	2026-07-08 20:49:10.650739-04	2026-07-08 20:49:10.650739-04
b9d07af2-856c-44e9-8623-2d02662bc455	c4029e46-c14e-465c-b870-b3b4ef8c06d5	b5927603-b5f5-457e-a78a-a6254d100318	12000.00	efectivo	74aa956e-5a01-4633-aebf-165e9e933974	\N	2026-07-08 21:13:11.630646-04	2026-07-08 21:13:11.630646-04
\.
...
COPY public.compra (id, proveedor_id, vendedor_id, precio_diario_id, precio_snapshot, cantidad, unidad, cantidad_kg, total, estado_sync, timestamp_local, timestamp_sync, dispositivo_id, nota, anulada, created_at, tipo_cacao, precio_quintal_snapshot, lote_secado_id, estado_pago, monto_pagado, saldo_pagar) FROM stdin;
3f17f871-aaa9-4eab-9c16-3f9d25c0cdc6	\N	50471f55-7b80-41ea-86ee-4e91338d3864	9a5c16e5-5d59-4203-8cf1-c881621b8e63	3000.0000	2.000	quintal	90.7184	272155.20	sincronizado	2026-07-04 16:31:20.459-04	\N	5eaca513-d1ae-4483-bb01-a29c8df487a1	\N	f	2026-07-04 16:31:22.303324-04	\N	\N	\N	pagado	0.00	0.00
b5927603-b5f5-457e-a78a-a6254d100318	c4029e46-c14e-465c-b870-b3b4ef8c06d5	2530a2db-1e70-4dfc-8d61-c5310112b4ff	6f6f87ac-fc88-4f40-8b3b-17ce0d107c73	220.0000	2.000	quintal_seco	100.0000	22000.00	sincronizado	2026-07-08 19:31:12.69-04	\N	41afdb78-f466-4571-a233-f0cf5022c06c	\N	f	2026-07-08 19:31:18.40937-04	seco	11000.0000	\N	pagado	22000.00	0.00
df0b5299-4b0b-4e57-afbe-eb04d1887fa0	\N	2530a2db-1e70-4dfc-8d61-c5310112b4ff	6f6f87ac-fc88-4f40-8b3b-17ce0d107c73	72.0000	50.000	kg	50.0000	3600.00	sincronizado	2026-07-08 19:32:45.948-04	\N	41afdb78-f466-4571-a233-f0cf5022c06c	\N	f	2026-07-08 19:32:51.85402-04	baba	9000.0000	\N	pagado	3600.00	0.00
\.
...
equivalencias_version	1	2026-07-04 18:21:45.012592-04
\.
...
COPY public.fondo_diario (id, vendedor_id, fecha, monto_asignado, monto_pagado, diferencia, cerrado) FROM stdin;
ee938339-fc58-4427-baea-cd48a5cdee8b	2530a2db-1e70-4dfc-8d61-c5310112b4ff	2026-07-09	20000.00	0.00	\N	f
17590033-3ed0-4eea-bf81-3f49f8d3018f	2530a2db-1e70-4dfc-8d61-c5310112b4ff	2026-07-08	25000.00	0.00	\N	f
\.
...
COPY public.precio_diario (id, fecha, precio_quintal_seco, precio_anterior, hora_cambio, fijado_por, created_at, precio_quintal_baba, precio_anterior_baba, precio_baba_calculado) FROM stdin;
9a5c16e5-5d59-4203-8cf1-c881621b8e63	2026-07-04	3000.0000	\N	16:30:55	50471f55-7b80-41ea-86ee-4e91338d3864	2026-07-04 16:30:57.478661-04	\N	\N	t
6f6f87ac-fc88-4f40-8b3b-17ce0d107c73	2026-07-08	11000.0000	\N	18:54:21	50471f55-7b80-41ea-86ee-4e91338d3864	2026-07-08 18:54:27.523317-04	9000.0000	\N	f
e0b79b1a-0c2b-4e80-8e8b-5e362522c524	2026-07-10	9500.0000	\N	21:24:38	50471f55-7b80-41ea-86ee-4e91338d3864	2026-07-10 21:24:38.325048-04	9000.0000	\N	f
5c89db68-e82e-4a14-a5a0-0090d8493ad0	2026-07-10	9500.0000	\N	21:24:43	50471f55-7b80-41ea-86ee-4e91338d3864	2026-07-10 21:24:43.879462-04	9000.0000	\N	f
0fa80ce7-946e-4126-a711-5d85d974ec8c	2026-07-10	9500.0000	\N	21:25:05	50471f55-7b80-41ea-86ee-4e91338d3864	2026-07-10 21:25:05.357012-04	9000.0000	\N	f
0a87c8ed-cfba-4588-b527-1b2b616285c7	2026-07-10	11000.0000	\N	21:25:17	50471f55-7b80-41ea-86ee-4e91338d3864	2026-07-10 21:25:17.155615-04	9000.0000	\N	f
c472a5f4-5ae4-4cd6-b9c5-0e26d27c3d76	2026-07-10	9500.0000	\N	21:25:41	50471f55-7b80-41ea-86ee-4e91338d3864	2026-07-10 21:25:41.133362-04	9000.0000	\N	f
\.
...
COPY public.proveedor (id, nombre, cedula, telefono, tipo, saldo_pendiente, activo, created_at) FROM stdin;
c4029e46-c14e-465c-b870-b3b4ef8c06d5	Juanito Perez	001-0012345-6	8095000000	registrado	0.00	t	2026-07-08 19:01:44.63864-04
c4113271-1876-4fc8-a82f-c38c35b4ac80	Pancho Joba	\N	\N	ocasional	0.00	t	2026-07-08 19:02:26.343598-04
\.
...
--
-- Data for Name: messages_2026_07_27; Type: TABLE DATA; Schema: realtime; Owner: supabase_realtime_admin
--

COPY realtime.messages_2026_07_27 (topic, extension, payload, event, private, updated_at, inserted_at, id, binary_payload) FROM stdin;
\.


--
-- Data for Name: messages_2026_07_28; Type: TABLE DATA; Schema: realtime; Owner: supabase_realtime_admin
--
...
--
-- Data for Name: messages_2026_07_29; Type: TABLE DATA; Schema: realtime; Owner: supabase_realtime_admin
--
...
--
-- Data for Name: messages_2026_07_30; Type: TABLE DATA; Schema: realtime; Owner: supabase_realtime_admin
--
...
--
-- Data for Name: messages_2026_07_31; Type: TABLE DATA; Schema: realtime; Owner: supabase_realtime_admin
--
...
--
-- Name: fondo_diario fondo_diario_vendedor_id_fecha_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.fondo_diario
    ADD CONSTRAINT fondo_diario_vendedor_id_fecha_key UNIQUE (vendedor_id, fecha);
...
--
-- Name: precio_diario precio_diario_fecha_hora_cambio_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.precio_diario
    ADD CONSTRAINT precio_diario_fecha_hora_cambio_key UNIQUE (fecha, hora_cambio);
...
--
-- Name: precio_diario precio_diario_fijado_por_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.precio_diario
    ADD CONSTRAINT precio_diario_fijado_por_fkey FOREIGN KEY (fijado_por) REFERENCES public.vendedor(id);
...
\unrestrict OSwinL1jqLlTiX2ZO4upBNnz6Eed70g22vAfd1xCtRKIm3fA1ykzjlwrssB2sl3
